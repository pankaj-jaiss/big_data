...
$('#selectall').click(function()
 { 
    $(this).parents('table').find('.checkuser').toggle()
    $(this).parents('table').find('input.selectAll').filter(':checkbox').prop('checked', this.checked);
});
...
// function sendAll() {
//     var x = document.querySelector('totaluser');
